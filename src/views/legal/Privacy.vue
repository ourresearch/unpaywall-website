<template>
    <div class="page privacy legal">
        ...
        describes the types of information we may collect from you when you visit <a href="https://unpaywall.org"
                                                                                     target="_blank">https://unpaywall.org</a>
        (the "<u>Site</u>," a component of the Service), when you use or interact with the API, or when you use or
        interact with any other products, applications, or features provided by us (collectively, the "<u>Service</u>"),
        as well as our practices for collecting, using, maintaining, protecting, and disclosing that information. Any
        capitalized terms used but not defined in this Policy are defined in our Terms of Service. <br>
        <br>
        ...
        check this Policy periodically for updates.<br>

        <h2>How this Privacy Policy Applies</h2>
        ...
        that may link to or be accessible from or through the Service.<br>
        ...
        <h2 id="types">Types of Information We Collect & How We Collect It</h2>
        ...
        <b>We do not collect any Personal Information when you use the Browser Extension.</b> We collect Personal
        ...
        individually, either by itself or in conjunction with other information.<br><br>
        Personal Information may include, without limitation:<br>
        <ul type="disc">
            <li>Contact Information, such as your name and email address</li>
            <li>Information about the organization for which you work;</li>
            <li>Demographic or location information, when that information is linked to other Personal Information or
        ...
        <b>Non-Personal Information.</b> Non-Personal Information includes information that is about you or about your
        use of the Service but does not identify you personally, such as:<br>
        <ul type="disc">
            <li>IP addresses</li>
        ...
        <b>How We Collect Non-Personal Information.</b> We generally collect Non-Personal Information through automatic
        data collection technologies, which are described in more detail below. <br>
        <br>
        <b>*The preceding lists of Personal Information and Non-Personal Information we may collect are illustrative,
            not exhaustive.</b><br>

        <h2>Automatic Data Collection and How We Use It</h2>

        <b>We do not collect Personal Information from users of the Browser Extension.</b> When you use the Browser
        Extension and view a page in your browser that we recognize to be a scholarly article, we send the DOI (a short
        unique ID for every scholarly article) of that article to our servers. <b>The Browser Extension does not use
        beacons, cookies or other automatic data collection technologies to track information.</b><br>
        <br>
        <b>For components of the Service other than the Browser Extension</b>, we may use automatic data collection
        ...
        and use of the Service in order to improve the Service. <br>
        <br>
        ...
        <ul type="disc">
            ...
            <li><b>Web Beacons.</b> Components of the Service and our e-mails may contain small electronic files known
        ...
        all Users, and for purposes related to furthering the sales and use of our technology and services. <br>
        <br>
        In situations where we have collected your Personal Infornation, we may use it to: <br>
        <ul type="disc">
            <li>Communicate with you.
                <ul type="circle">
                    <li>For example, we may use your email address to contact you in response to your question or
            ...
            <li>Enforce our Terms of Service and other policies, and preventing prohibited or illegal activities, or
                violations of our Terms of Service;
            </li>
            <li>Improve the Service;
                <ul type="circle">
                    <li>For example, we may identify ways to improve the Service based on your IP address activity or
                        support requests you submit.
                    </li>
                </ul>
            </li>
            <li>To allow you to participate in interactive features on the Site;</li>
            <li>Administer referral programs, rewards, surveys, contests, or other promotional activities or sponsored
                events;
            </li>
            <li>Comply with our legal obligations, resolve any disputes that we may have with any of our users, and
        ...
        Feed Agreement as described in the Data Feed Agreement.<br>
        <br>
        ...
        technical purposes like server load-balancing or bug fixing. <br>
        <br>
        ...
        and to the Data Reports, including all associated intellectual property rights.<br>
        ...
        specific individual for business purposes. <br>
        <br>
        ...
        your Personal Information with third parties without your consent. <br>
        ...
        <h2>Your Rights Related to Your Information</h2>
        ...
        provide you a copy in a structured, electronic format. <br>
        ...
        under applicable law in order to assess your request prior to any deletion of data.<br>
        <br>
        ...
        but we may still store your data as permitted under applicable law pending an assessment of your request. <br>
        <br>
        ...
        violate any law or legal requirement, or if such change would cause the information to be incorrect. <br>
        <br>
        ...
        with the Data Feed Subscription you requested.<br>
        ...
        in de-identified, aggregated form with data of other users (such as usage trend reports).<br>
        <br>
        ...
        you consent to any and all such transfers.<br>
        ...
        check the Site and this privacy page for updates.<br>
        <br>
        ...
        assets may continue to process your Personal Information as set forth in this Privacy Policy. <br>

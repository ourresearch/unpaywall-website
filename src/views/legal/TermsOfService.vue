<template>
    <div class="page terms-of-service legal">
        <h1>Unpaywall Terms of Service</h1>

        <em>Last Revised: 9 June 2018</em><br>
        <br>
        <br>
        Welcome to Unpaywall! Unpaywall is a website featuring web-based tools created and maintained by Impactstory, Inc.  To make these Terms (the "<u>Terms</u>") easier to read, we will sometimes refer to Impactstory (including our directors, officers, members, managers, employees, service providers, affiliates, successors and assigns) as "<u>our</u>", "<u>we</u>", or "<u>us</u>"; we will refer to you as "<u>you</u>" or a derivative of you; and we will refer to user(s) of the Service (including you) as "User(s)". These Terms apply when you browse or use the Unpaywall website maintained by Impactstory  located at <a href="https://unpaywall.org">https://unpaywall.org</a> (the "<u>Site</u>", a component of the "<u>Service</u>"), or in any way access or utilize any other components of the Service, if any and when available. <br>
        <br>
        Please review these Terms and the Impactstory Privacy Policy carefully <b><u>before</u></b> you begin using the Service. Our Privacy Policy describes what information we collect from you, how we collect information from you, and how we use and share information we collect from you. By using the Service, you accept and agree to be bound and abide by these Terms of Use and our Privacy Policy, which together create a binding legal agreement between you and Impactstory. Certain features of the Service, such as the Data Feed (as defined below), may be subject to additional guidelines, terms, or rules, which may be set forth in a separate written agreement between you and Impactstory, or posted on the Site in connection with such features. All such additional terms, guidelines, and rules are incorporated by reference into these Terms. If you do not agree to these Terms or the Privacy Policy, you must not access or use the Service. <br>

        <h3>About the Service</h3>

        Impactstory provides a database (the "<u>Database</u>") of aggregated information (the "<u>Data</u>") related to publicly available scientific and other academic publications ("<u>Publications</u>"). The Data is obtained in accordance with our Privacy Policy from third party services or websites which publish, host, and/or maintain the Publications or indexes of Publications published or hosted by others  ("<u>External Platforms</u>"). You can use the Database and the Data to identify and locate Publications that are publicly available through External Platforms or otherwise from third parties. We make the Data available through a variety of tools (each a component of the Service), including without limitation, an an application programming interface ("<u>API</u>"), a snapshot of all or part of the Data contained in the Database at a given time, a premium service for consuming updates to the Data and Database ("<u>Data Feed</u>"), a web-based graphical user interface, a web browser extension ("<u>Browser Extension</u>"), among others that may be available. The various tools we use to make the Data available differ with respect to the volume, frequency, and type or format of the Data you can access from the Database.<br>

        <h3>Eligibility to Use the Service</h3>

        You must be at least 13  years old in order to use the Service. By using the Service, you represent and warrant that you are of legal age to form a binding contract with Impactstory and use the Service in accordance with these Terms. If you register and use the Service on behalf of another entity or third party, you must have the proper authority to register, use the Service, and bind the entity or third party for which you are using the Service. <b>If you do not meet these requirements or, if for any reason, you do not agree with all of the terms and conditions contained in these Terms, you must stop using the Service immediately.</b> <br>

        <h3>Users Are Not Required to Register to Use Most Features of the Service</h3>

        We provide most features of the Service free of charge, and you generally do not need to register to use most features of the Service. Users who wish to access and use the Data Feed must register and pay for a Data Feed subscription, which is available as a monthly or annual subscription ("<u>Data Feed Subscription</u>"). The Data Feed Subscription is described in more detail below, and at our Data Feed webpage. All information we collect or process in connection with your use of the Service is subject to our Privacy Policy. <br>

        <h3>Subscribing to the Data Feed</h3>
        ...
        <h3>You May Not Use the Service for Any Improper Purpose</h3>
        ...
        <ul type="disc">
            ...
            <li>Provide others with access to or use of your Data Feed subscription, or access or use the Data Feed subscription of any other user without permission;</li>
            <li>Provide false or inaccurate information when registering for the Service or a Data Feed subscription;</li>
            <li>Use the Service for the purpose of exploiting, harming, or attempting to exploit or harm minors in any way by exposing them to inappropriate content, asking for personally identifiable information, or otherwise;</li>
            <li>Use the Service to obtain, transmit, or otherwise improperly handle confidential or proprietary information of any third party;</li>
            <li>Use the Service in any manner which may infringe upon, misappropriate, or otherwise violate the intellectual property rights or other rights of any External Platforms or any other third party, including but not limited to, trademark, copyright, and/or other privacy rights;</li>
            <li>Make any automated use of the Service, except as expressly permitted under these Terms, or take any action that we deem to impose or to potentially impose an unreasonable or disproportionately large load on the Service; </li>
            <li>Use any manual or technical process to monitor or copy any of the Data for any other unauthorized purpose without our prior written consent;</li>
            <li>Reverse engineer or attempt to extract any protected source code of the software or tools available as part of the Service, unless applicable laws prohibit these restrictions or you have our written permission to do so; </li>
            <li>Introduce any viruses, trojan horses, worms, logic bombs, or other material that is malicious or technologically harmful;</li>
            <li>Bypass any measures we take to restrict access to the Service; or</li>
        ...
        <ul type="disc">
            ...
            <li>Information reasonably sufficient to permit Impactstory to contact you, such as an address, telephone number, and/or email address; </li>
        ...
        <br>
        The Data may contain links and information related to Publications written by third parties, and all statements and/or opinions expressed in such Publications are solely the opinions and the responsibility of the author and/or party responsible for such Publication, and not the opinion of Impactstory. We are not responsible, or liable to you or any third party, for accuracy, truthfulness, reliability or otherwise of any Data or Publication.<br>

        <h3>The Service is Provided "As-Is" and Without Any Warranty</h3>

        FOR THE PURPOSE OF THIS SECTION, THE "SERVICE" REFERS TO THE SERVICE (AS DEFINED ABOVE), AS WELL AS ALL DATA, MATERIALS, CONTENT, AND INFORMATION PROVIDED TO YOU OR OTHERWISE MADE AVAILABLE IN CONNECTION WITH ANY FEATURE OF THE SERVICE. <br>
        <br>
        THE SERVICE IS PROVIDED "AS IS." IMPACTSTORY MAKES NO WARRANTIES OF ANY KIND (WHETHER EXPRESS, IMPLIED, STATUTORY OR OTHERWISE) REGARDING THE SERVICE, ANY COMPONENT OF THE SERVICE, OR THE USE OR PERFORMANCE OF THE SERVICE OR ANY COMPONENT OF THE SERVICE. <br>
        <br>
        FOR EXAMPLE, WE DO NOT WARRANT THAT <br>
        (I) THE SERVICE WILL MEET YOUR SPECIFIC REQUIREMENTS; <br>
        (II) THE SERVICE WILL BE UNINTERRUPTED, TIMELY, ABSOLUTELY SECURE, OR ERROR-FREE; <br>
        (III) THE QUALITY OF THE SERVICE, OR OF ANY DATA, CONTENT, INFORMATION, OR OTHER MATERIAL YOU OBTAIN THROUGH THE SERVICE WILL MEET YOUR EXPECTATIONS;<br>
        (IV) ANY ERRORS IN THE DATA, DATABASE, OR ANY FEATURE OF THE SERVICE WILL BE DETECTED AND/OR CORRECTED; OR <br>
        (V) THE SERVICE OR YOUR USE OF ANY DATA OR OTHER MATERIALS OR INFORMATION WILL NOT INFRINGE ON THE INTELLECTUAL PROPERTY OR OTHER RIGHTS OF ANY THIRD PARTY<br>
        <br>
        YOU ASSUME FULL RESPONSIBILITY AND RISK OF LOSS RESULTING FROM YOUR USE OF THE SERVICE OR ANY COMPONENT OF THE SERVICE. SOME JURISDICTIONS LIMIT OR DO NOT PERMIT DISCLAIMERS OF WARRANTY, SO THIS PROVISION MAY NOT APPLY TO YOU.<br>

        <h3>You Agree Impactstory Will Not Be Liable</h3>

        TO THE EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL IMPACTSTORY, ITS AFFILIATES, DIRECTORS, EMPLOYEES, LICENSORS OR PARTNERS, BE LIABLE TO YOU FOR ANY LOSS OF PROFITS, USE,  OR DATA, OR FOR ANY INCIDENTAL, INDIRECT, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, HOWEVER ARISING, THAT RESULT FROM (A) THE USE, DISCLOSURE, OR DISPLAY OF ANY DATA, PUBLICATIONS, AND/OR EXTERNAL PLATFORM DATA; (B) YOUR USE OF OR INABILITY TO USE THE SERVICE OR ANY COMPONENT OF THE SERVICE; (C) THE SERVICE GENERALLY OR THE SOFTWARE OR SYSTEMS THAT MAKE THE SERVICE AVAILABLE; OR (D) ANY OTHER INTERACTIONS WITH IMPACTSTORY OR ANY OTHER USER OF THE SERVICE, WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE) OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT IMPACTSTORY HAS BEEN INFORMED OF THE POSSIBILITY OF SUCH DAMAGE. SOME JURISDICTIONS LIMIT OR DO NOT PERMIT DISCLAIMERS OF LIABILITY, SO THIS PROVISION MAY NOT APPLY TO YOU. <br>
        <br>
